...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    category: "Listen",
    description:
      "A podcast for leaders who want to grow their self-awareness and create feedback-rich cultures.",
    detailDescription:
      "Leading Above the Line is a podcast designed for managers and leaders who are serious about their own growth. Each episode explores themes like psychological safety, honest communication, and what separates good leaders from great ones.\n\nIt's practical, conversational, and grounded in real leadership challenges rather than theory. The hosts bring in guests with a range of perspectives, so episodes vary in tone and focus — worth scanning titles to find what's most relevant to where you are right now.\n\nWhether you're commuting or working out, this is a reliable way to keep learning without carving out extra time in your week. New episodes drop regularly, making it an ongoing resource rather than a one-time listen.",
  ...
  },
  {
    ...
    detailDescription:
      "Drive challenges the assumption that people are primarily motivated by external rewards like money and status. Pink draws on decades of behavioural science to show that autonomy, mastery, and purpose are the real drivers of sustained performance — especially for complex, creative work.\n\nFor anyone thinking about feedback culture, this book is essential context: it explains why feedback tied to performance reviews often demotivates people, and what kinds of feedback actually help people grow. The research on intrinsic vs. extrinsic motivation is surprising and, once you see it, hard to unsee.\n\nIt's well-written, full of surprising research, and practical enough to apply immediately whether you're leading a team or thinking about your own development.",
